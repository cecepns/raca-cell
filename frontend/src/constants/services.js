...
export const SERVICES = [
  ...
  {
    id: 'bpjs-kesehatan-pasca',
    label: 'BPJS Kesehatan',
    description: 'Bayar iuran BPJS Kesehatan',
    icon: HeartPulse,
    color: 'bg-rose-500',
    type: 'pasca',
    customerLabel: 'No. VA BPJS Kesehatan',
    customerPlaceholder: 'Nomor VA atau kartu BPJS Kesehatan',
    minLength: 8,
  },
  {
    id: 'bpjs-tk-pasca',
    ...
    color: 'bg-red-500',
    type: 'pasca',
    customerLabel: 'No. Peserta / NIK',
    customerPlaceholder: 'Nomor peserta BPJS Ketenagakerjaan',
    minLength: 8,
  },
];
